...
namespace PocoDataSet.ObservableTests
{
    ...
    /// </summary>
    public class ObservablePostSaveDeletedRowsNotResurrectedTests
    {
        [Fact]
        public void PostSave_RemovesDeletedRow_AndDoesNotResurrect_WhenChangesetContainsRowMatchingCurrentDeletedRow_ByPk()
        {
            // ------------------------------------------------------------
            // Arrange
            // ------------------------------------------------------------
