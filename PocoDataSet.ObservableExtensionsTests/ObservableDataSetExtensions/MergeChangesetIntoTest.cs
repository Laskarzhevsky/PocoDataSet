...
namespace PocoDataSet.ObservableExtensionsTests.ObservableDataSetExtensions
{
    ...
    {
        [Fact]
        public void MergeChangesetIntoTest()
        {
            // Arrange
            ...
            Assert.Single(mergeResultDataSet.Tables["Department"].Rows);
            Assert.Equal(2, mergeResultDataSet.GetFieldValue<int>("Department", 0, "Id"));

            Assert.Single(mergeResultDataSet.Tables["EmploymentType"].Rows);
            Assert.Equal(2, mergeResultDataSet.GetFieldValue<int>("EmploymentType", 0, "Id"));

            Assert.Single(mergeResultDataSet.Tables["Employee"].Rows);
