...
namespace PocoDataSet.ObservableExtensionsTests.Merging
{
    ...
    {
        /// <summary>
        /// Verifies DoesNotThrow WhenCurrentCompositePkContainsDBNull StringPart AndRefreshedHasNonNullPk in RefreshMergePreservingLocalChanges merge.
        ///
        ...
        /// </summary>
        [Fact]
        public void NoThrow_CurrentCompositePkContainsDBNull_StringPart_ServerHasNonNullPk()
        {
            IObservableDataSet current = MergeTestingHelpers.CreateCurrentObservableWithCompositePkRow(1, DBNull.Value);
