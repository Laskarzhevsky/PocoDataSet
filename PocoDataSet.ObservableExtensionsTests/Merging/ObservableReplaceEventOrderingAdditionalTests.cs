...
namespace PocoDataSet.ObservableExtensionsTests
{
    ...
    /// </summary>
    public class ObservableReplaceEventOrderingAdditionalTests
    {
        [Fact]
        public void ReplaceMerge_RaisesRowsRemoved_BeforeRowsAdded_AndDoesNotRaiseDataFieldValueChanged()
        {
            // Arrange
