...
namespace PocoDataSet.ObservableExtensions
{
    ...
    {
        public static void DoRefreshMergeIfNoChangesExist(this IDataRow currentDataRow, IDataRow refreshedDataRow, string currentObservableDataTableName, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions)
        {
        ...
        public static void DoRefreshMergeIfNoChangesExist(this IObservableDataRow currentObservableDataRow, IDataRow refreshedDataRow, string currentObservableDataTableName, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions)
        {
