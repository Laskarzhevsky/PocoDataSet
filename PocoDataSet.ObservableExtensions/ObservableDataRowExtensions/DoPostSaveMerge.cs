...
namespace PocoDataSet.ObservableExtensions
{
    ...
    {
        public static void DoPostSaveMerge(this IDataRow currentDataRow, IDataRow refreshedDataRow, string currentObservableDataTableName, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions)
        {
        ...
        public static void DoPostSaveMerge(this IObservableDataRow currentObservableDataRow, IDataRow refreshedDataRow, string currentObservableDataTableName, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions)
        {
