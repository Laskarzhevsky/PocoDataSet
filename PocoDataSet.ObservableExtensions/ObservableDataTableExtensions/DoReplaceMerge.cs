...
namespace PocoDataSet.ObservableExtensions
{
    ...
    {
        public static void DoReplaceMerge(this IObservableDataTable currentObservableDataTable, IDataTable refreshedDataTable, IObservableMergeOptions observableMergeOptions)
        {
