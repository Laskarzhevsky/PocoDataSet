...
namespace PocoDataSet.ObservableExtensions
{
    ...
    {
        public static void DoPostSaveMerge(this IObservableDataTable currentObservableDataTable, IDataTable refreshedDataTable, IObservableMergeOptions observableMergeOptions)
        {
