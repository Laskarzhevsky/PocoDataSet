...
{
    public static partial class ObservableDataViewExtensions
    {
        /// <summary>
        /// Returns a shallow copy of the table's observable rows.
        /// Keeping a copy avoids accidental mutation while iterating/sorting.
        /// </summary>
        public static List<IObservableDataRow> ToList(this IObservableDataView observableDataView)
        {
            return new List<IObservableDataRow>(observableDataView.Rows);
        }
        ...
        /// </summary>
        public static List<TInterface> ToList<TInterface>(this IObservableDataView table, IDictionary<string, string>? nameMap) where TInterface : class
        {
            if (table == null)
            {
