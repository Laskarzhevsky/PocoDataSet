...
namespace PocoDataSet.ObservableExtensions
{
    ...
    {
        bool MergeDataRow(string currentObservableDataTableName, IDataRow currentDataRow, IDataRow refreshedDataRow, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions);

        bool MergeObservableRow(string currentObservableDataTableName, IObservableDataRow currentObservableDataRow, IDataRow refreshedDataRow, IReadOnlyList<IColumnMetadata> listOfColumnMetadata, IObservableMergeOptions observableMergeOptions);
    }
    ...
    /// </summary>
    internal sealed class ObservableDataTableMergeEngine
    {
