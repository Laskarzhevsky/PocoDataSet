namespace PocoDataSet.IData
{
    ...
    public enum MergeMode
    {
        ...
        /// 
        /// Used to synchronize client-side temporary keys (e.g., client-generated IDs)
        /// with server-generated keys and to update row values returned by the server.
        /// 
        /// Deleted rows are permanently removed from the table and all remaining rows
        /// transition to the Unchanged state.
        /// </summary>
        PostSave,
        ...
        /// 
        /// Intended for read-only, polling, or search-result scenarios where
        /// the current table is expected to be clean.
        /// </summary>
        RefreshIfNoChangesExist,

        /// <summary>
        /// Reconciles refreshed data with the current table using primary keys,
        /// while preserving local pending changes.
        /// 
        /// Existing rows are matched by primary key and updated only if their state
        /// allows overwrite according to merge rules.
        /// 
        /// Rows present in the refreshed data but missing locally are added.
        /// Rows missing from the refreshed data may be removed if they are in the
        /// Unchanged state.
        /// 
