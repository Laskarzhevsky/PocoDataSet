...
namespace PocoDataSet.Tests
{
    ...
    /// </summary>
    public class RefreshNoOpStabilityAdditionalTests
    {
        [Fact]
        public void RefreshPreservingLocalChanges_WhenAllValuesIdentical_DoesNotRecordMergeResultEntries_AndDoesNotChurnRows()
        {
            // ------------------------------------------------------------
            // Arrange
            // ------------------------------------------------------------
