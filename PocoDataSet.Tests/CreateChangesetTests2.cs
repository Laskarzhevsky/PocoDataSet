...
{
    public  class CreateChangesetTests2
    {
        [Fact]
        public void CreateChangeset_ReturnsNull_WhenDataSetIsNull()
        {
            // Arrange
        ...
        [Fact]
        public void CreateChangeset_ReturnsEmptyDataSet_WhenNoChanges()
        {
            // Arrange
        ...
        [Fact]
        public void CreateChangeset_ModifiedRow_ContainsPrimaryKey_ClientKey_AndOnlyChangedColumns()
        {
            // Arrange
            IDataSet dataSet = DataSetFactory.CreateDataSet();
        ...
        [Fact]
        public void CreateChangeset_ModifiedRow_IncludesAllCompositePrimaryKeyColumns()
        {
            // Arrange
            IDataSet dataSet = DataSetFactory.CreateDataSet();
        ...
        [Fact]
        public void CreateChangeset_ModifiedRow_DoesNotIncludeColumn_WhenValueEqualsOriginal()
        {
            // Arrange
            IDataSet dataSet = DataSetFactory.CreateDataSet();
        ...
        [Fact]
        public void CreateChangeset_TwoModifiedRows_WithDifferentChangedColumns_AreSparseIndependently()
        {
            // Arrange
            IDataSet dataSet = DataSetFactory.CreateDataSet();
        ...
        [Fact]
        public void CreateChangeset_ModifiedRow_IncludesColumn_WhenOriginalValueMissing()
        {
            // Arrange
            IDataSet dataSet = DataSetFactory.CreateDataSet();
