...
{
    /// <summary>
    /// Merge result invariants: Added/Updated entries must refer to rows present in the final table,
    /// Deleted entries must refer to PKs not present in the final table.
    /// These tests protect against future refactors that drift merge result reporting away from actual table state.
    /// </summary>
    public sealed class MergeResultInvariantsAdditionalTests
    {
        [Fact]
        public void RefreshPreservingLocalChanges_ResultEntries_MatchFinalTableState()
        {
            ...
            // Row 2 updated, Row 3 added, Row 1 missing => deleted
            ...
            // Assert - Added/Updated rows exist in final table
